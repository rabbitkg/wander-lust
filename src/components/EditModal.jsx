    ...
    return (
        <Modal>
            <Modal.Trigger>
                ...
                <button className="flex items-center gap-2 border border-gray-300 bg-white px-5 py-2 text-sm hover:bg-gray-100 transition cursor-pointer">
                    <FaPencilAlt size={12} />
                    Edit
                </button>
            </Modal.Trigger>
                ...
                <Modal.Container placement="auto">
                    <Modal.Dialog className="sm:max-w-xl">
                        ...
                        <Modal.Body className="p-3">
                            ...
                            <Button type="submit" slot="close">Save This</Button>
                        </Modal.Footer>
                                </form>
                            </Surface>
                        </Modal.Body>
